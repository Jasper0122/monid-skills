...
| [`honeypot-killer`](skills/honeypot-killer/SKILL.md) | Crypto Honeypot Killer — layered pre-buy scam screener. Anti-impersonation contract check → dual-source honeypot test → deployer rap sheet → holder concentration / upgradeability / unlocks → KILL / CAUTION / CLEAR verdict. Read-only; never buys or signs. |
